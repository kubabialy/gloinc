...
| `gloinc` | File-reading CLI linked against `gloin_backend`; emits native executables by default and supports explicit JIT run, check, object output, and verified IR inspection. See [CLI reference](cli.md). |
